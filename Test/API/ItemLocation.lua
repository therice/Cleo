-- https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ObjectAPI/Mainline/ItemLocation.lua
--- @class ItemLocation
ItemLocation = {}
--- @class ItemLocationMixin
ItemLocationMixin = {}

_G.ItemLocation = ItemLocation
_G.ItemLocationMixin = ItemLocationMixin
