...
L["announce_&o_desc"] = "|cfffcd400 &o|r: item owner"
...
L["award"] = "Award"
L["awarded_cannot_award_later"] = "Awarded item cannot be awarded later (THIS IS A BUG)"
L["award_for"] = "Award for"
L["award_later"] = "Award Later"
L["award_later_cannot_repeat"] = "'Award Later' item cannot be awarded later (THIS IS A BUG)"
L["award_later_description"] = "Check to automatically check the 'Award Later' option in the Session Frame"
L["award_later_not_supported"] = "'Award Later' isn't supported while testing"
...
L["changes"] = "Change(s)"
L["changing_loot_method_to_ml"] = "Changing loot method to master looter"
L["channel"] = "Channel"
...
L["chat_commands_trade"] = "Opens the Loot Trade interface"
...
L["confirm_add_to_trade_window"] = "%d items in your bags are awarded to %s. Do you want to add these items to the trade window?"
L["confirm_award_item_to_player"] = "Are you certain you want to give %s to %s?"
L["confirm_award_later"] = "Are you sure you want to award %s later? The item will be recorded to the loot ledger and you will loot the item if present in a loot slot."
...
L["frame_loot_trade"] = "" .. name_colored .. " : Loot Trade"
...
L["in_bags"] = "In bags, not in ledger"
L["in_ledger"] = "In ledger"
L["insert"] = "Insert"
...
L["item"] = "Item"
L["items"] = "Items"
L["item_ambiguous_source"] = "Item is not looted but present in the player's bags (THIS IS A BUG)"
...
L["item_added_to_award_later"] = "%s will be awarded later"
L["item_id"] = "Item Id"
L["item_from_different_source"] = "Item originated from a loot source different than currently being looted"
L["item_looted_for_award_later"] = "item looted to bags and will be awarded later"
...
L["item_no_source"] = "No available loot source for item (THIS IS A BUG)"
...
L["item_to_trade_not_found"] = "Item %s to trade could not be found in your inventory"
L["item_to_trade_changed"] = "Item %s to trade is not available at expected bag and slot"
L["item_trade_complete"] = "%s traded %s to %s"
L["item_trade_wrong_winner"] = "WARNING: %s traded %s to %s instead of %s"
L["kill"] = "Victory"
L["kills"] = "Victories"
...
L["list_priority_announcement"] = "(%s) %s Priority%s : [Raid] %s -> %s [Overall] %s -> %s"
L["logging"] = "Logging"
...
L["responses_non_preferred_armor_type_enable"] = "Display armor of non-preferred type"
L["responses_non_preferred_armor_type_desc"] = "If enabled, display all equipable types of armor in loot window.\nIf disabled, display only preferred type of armor in loot window.\nFor example, the preferred armor type for Druid is leather but they can also equip cloth."
...
L["trade"] = "Trade"
L["trade_time_remaining"] = "Time Remaining"
