...
L["award_later_cannot_reward"] = "Awarded item cannot be awarded later (THIS IS A BUG)"
L["award_later_description"] = "Check to automatically check the 'Award Later' option in the Session Frame"
L["award_later_missing_winner"] = "'Award Later' item without a winner (THIS IS A BUG)"
