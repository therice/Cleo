...
describe("Lists", function()
	...
	describe("functional", function()
		...
		it("provides unassigned equipment", function()
			...
			assert.same(
				{'INVTYPE_2HWEAPON', 'INVTYPE_CLOAK', 'INVTYPE_FEET', 'INVTYPE_FINGER', 'INVTYPE_HAND', 'INVTYPE_HOLDABLE', 'INVTYPE_NECK', 'INVTYPE_RANGED',  'INVTYPE_SHIELD',  'INVTYPE_TRINKET', 'INVTYPE_WAIST', 'INVTYPE_WAND', 'INVTYPE_WEAPON', 'INVTYPE_WEAPONMAINHAND', 'INVTYPE_WEAPONOFFHAND', 'INVTYPE_WRIST'},
				ua
			)
		end)
