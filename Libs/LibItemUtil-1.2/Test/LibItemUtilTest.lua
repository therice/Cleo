...
describe("LibItemUtil", function()
    ...
    describe("item ids", function()
        ...
        it("resolve whether a class can use", function()
            ...
            assert.is.False(ItemUtil:ClassCanUse("DRUID", 28))
            assert.is.False(ItemUtil:ClassCanUse("WARRIOR", 28))
            ...
            assert.is.False(ItemUtil:ClassCanUse('PRIEST', 4294967295, INVTYPE_CHEST, LE_ITEM_CLASS_ARMOR, LE_ITEM_ARMOR_LEATHER))
            ...
            assert.is.False(ItemUtil:ClassCanUse('WARRIOR', 4294967295, INVTYPE_CHEST, LE_ITEM_CLASS_ARMOR, LE_ITEM_ARMOR_LEATHER, true))
            assert.is.False(ItemUtil:ClassCanUse('SHAMAN', 4294967295, INVTYPE_CHEST, LE_ITEM_CLASS_ARMOR, LE_ITEM_ARMOR_LEATHER, true))
            assert.is.True(ItemUtil:ClassCanUse('SHAMAN', 4294967295, INVTYPE_SHIELD, LE_ITEM_CLASS_ARMOR, LE_ITEM_ARMOR_SHIELD, true))
            assert.is.False(ItemUtil:ClassCanUse('PRIEST', 4294967295, INVTYPE_SHIELD, LE_ITEM_CLASS_ARMOR, LE_ITEM_ARMOR_SHIELD, true))
            assert.is.False(ItemUtil:ClassCanUse('MONK', 4294967295, INVTYPE_2HWEAPON, LE_ITEM_CLASS_WEAPON, LE_ITEM_WEAPON_MACE2H))
            assert.is.True(ItemUtil:ClassCanUse('MONK', 4294967295, INVTYPE_2HWEAPON, LE_ITEM_CLASS_WEAPON, LE_ITEM_WEAPON_POLEARM))
            assert.is.True(ItemUtil:ClassCanUse('MONK', 4294967295, INVTYPE_2HWEAPON, LE_ITEM_CLASS_WEAPON, LE_ITEM_WEAPON_STAFF))
        end)
    ...
    describe("custom items", function()
        ...
        it("can be removed", function()
            ...
            assert.equal(1, GetSize(ItemUtil:GetCustomItems()), "Expected custom item count incorrect")
        end)
    end)
end)
