...
lib.TokenEquipmentLocations = {
    ...
    ** Where do I get Regalia?
    ...
    -- MOP Classic P5 (T16)
    -- Does NOT include Flex tier tokens, only Normal and Heroic
    [99689] = { "HeadSlot" },       -- Helm of the Cursed Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [99724] = { "HeadSlot" },       -- Helm of the Cursed Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [99694] = { "HeadSlot" },       -- Helm of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [99725] = { "HeadSlot" },       -- Helm of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [HEROIC]
    [99683] = { "HeadSlot" },       -- Helm of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [99723] = { "HeadSlot" },       -- Helm of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [99687] = { "HandsSlot" },      -- Gauntlets of the Cursed Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [99721] = { "HandsSlot" },      -- Gauntlets of the Cursed Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [99692] = { "HandsSlot" },      -- Gauntlets of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [99722] = { "HandsSlot" },      -- Gauntlets of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [HEROIC]
    [99682] = { "HandsSlot" },      -- Gauntlets of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [99720] = { "HandsSlot" },      -- Gauntlets of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [99686] = { "ChestSlot" },      -- Chest of the Cursed Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [99715] = { "ChestSlot" },      -- Chest of the Cursed Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [99696] = { "ChestSlot" },      -- Chest of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [99716] = { "ChestSlot" },      -- Chest of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [HEROIC]
    [99691] = { "ChestSlot" },      -- Chest of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [99714] = { "ChestSlot" },      -- Chest of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [99688] = { "LegsSlot" },       -- Leggings of the Cursed Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [99712] = { "LegsSlot" },       -- Leggings of the Cursed Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [99693] = { "LegsSlot" },       -- Leggings of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [99713] = { "LegsSlot" },       -- Leggings of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [HEROIC]
    [99684] = { "LegsSlot" },       -- Leggings of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [99726] = { "LegsSlot" },       -- Leggings of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [99690] = { "ShoulderSlot" },   -- Shoulders of the Cursed Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [99718] = { "ShoulderSlot" },   -- Shoulders of the Cursed Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [99695] = { "ShoulderSlot" },   -- Shoulders of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [99719] = { "ShoulderSlot" },   -- Shoulders of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [HEROIC]
    [99685] = { "ShoulderSlot" },   -- Shoulders of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [99717] = { "ShoulderSlot" },   -- Shoulders of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [105858] = { "ChestSlot", "HandsSlot", "HeadSlot", "LegsSlot", "ShoulderSlot" }, -- Essence of the Cursed Conqueror [NORMAL]
    [105867] = { "ChestSlot", "HandsSlot", "HeadSlot", "LegsSlot", "ShoulderSlot" }, -- Essence of the Cursed Conqueror [HEROIC]
    [105857] = { "ChestSlot", "HandsSlot", "HeadSlot", "LegsSlot", "ShoulderSlot" }, -- Essence of the Cursed Protector [NORMAL]
    [105866] = { "ChestSlot", "HandsSlot", "HeadSlot", "LegsSlot", "ShoulderSlot" }, -- Essence of the Cursed Protector [HEROIC]
    [105859] = { "ChestSlot", "HandsSlot", "HeadSlot", "LegsSlot", "ShoulderSlot" }, -- Essence of the Cursed Vanquisher [NORMAL]
    [105868] = { "ChestSlot", "HandsSlot", "HeadSlot", "LegsSlot", "ShoulderSlot" }, -- Essence of the Cursed Vanquisher [HEROIC]
}
...
lib.TokenItems = {
	...
	-- MOP Classic P3 (T15)
	-- This does not include Celestial gear, as it is obtained via dungeons and currency
	-- Normal is 522, Thunderforged is 528, Heroic is 535, Heroic Thunderforged is 541
	--
	-- Examples of variants of an item obbtained via a armor token (Leggings of the Crackling Protector)
	--
    -- UPDATE : Tier cannot be Thunderforged (either normal or heroic). Keeping this as reference of my buffoonery
    --
	-- Saurok Stalker's Legguards Item Link Reference (MoP Classic / Throne of Thunder)
	-- Variant                 | Item ID | iLevel | MoP Classic Link
	-- -------------------------------------------------------------------------------
	-- Normal                  | 95258   | 522    | |cffa335ee|Hitem:95258::::::::90::268::::::::|h[Saurok Stalker's Legguards]|h|r
	-- Normal Thunderforged    | 96257   | 528    | |cffa335ee|Hitem:96257::::::::90::268::::::::|h[Saurok Stalker's Legguards]|h|r
	-- Heroic                  | 96629   | 535    | |cffa335ee|Hitem:96629::::::::90::268::::::::|h[Saurok Stalker's Legguards]|h|r
	-- Heroic Thunderforged    | 97001   | 541    | |cffa335ee|Hitem:97001::::::::90::268::::::::|h[Saurok Stalker's Legguards]|h|r
    --
    [95571] = { 95227, 95232, 95237, 95241, 95246, 95252, 95261, 95307 },           -- Helm of the Crackling Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [96623] = { 96571, 96576, 96581, 96585, 96590, 96596, 96635, 96681 },           -- Helm of the Crackling Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [95577] = { 95282, 95287, 95292, 95296, 95301, 95326 },                         -- Helm of the Crackling Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [96624] = { 96656, 96661, 96666, 96670, 96675, 96726 },                         -- Helm of the Crackling Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [95582] = { 95257, 95267, 95271, 95277, 95312, 95317, 95322, 95330, 95337 },    -- Helm of the Crackling Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [96625] = { 96628, 96641, 96645, 96651, 96686, 96691, 96696, 96730, 96737 },    -- Helm of the Crackling Protector (Warrior, Hunter, Shaman, Monk [HEROIC]
    [95570] = { 95226, 95231, 95236, 95240, 95245, 95251, 95260, 95306 },           -- Gauntlets of the Crackling Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [96599] = { 96570, 96575, 96580, 96584, 96589, 96595, 96634, 96680 },           -- Gauntlets of the Crackling Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [95575] = { 95281, 95286, 95291, 95295, 95300, 95325 },                         -- Gauntlets of the Crackling Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [96600] = { 96655, 96660, 96665, 96669, 96674, 96725 },                         -- Gauntlets of the Crackling Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [95580] = { 95256, 95266, 95270, 95276, 95311, 95316, 95321, 95332, 95336 },    -- Gauntlets of the Crackling Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [96601] = { 96627, 96640, 96644, 96650, 96685, 96690, 96695, 96732, 96736 },    -- Gauntlets of the Crackling Protector (Warrior, Hunter, Shaman, Monk [HEROIC]
    [95569] = { 95225, 95230, 95235, 95243, 95248, 95250, 95263, 95305 },           -- Chest of the Crackling Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [96566] = { 96569, 96574, 96579, 96587, 96592, 96594, 96637, 96679 },           -- Chest of the Crackling Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [95574] = { 95280, 95285, 95290, 95298, 95303, 95328 },                         -- Chest of the Crackling Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [96567] = { 96654, 96659, 96664, 96672, 96677, 96728 },                         -- Chest of the Crackling Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [95579] = { 95255, 95265, 95273, 95275, 95310, 95315, 95320, 95331, 95335 },    -- Chest of the Crackling Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [96568] = { 96626, 96639, 96647, 96649, 96684, 96689, 96694, 96731, 96735 },    -- Chest of the Crackling Protector (Warrior, Hunter, Shaman, Monk [HEROIC]
    [95572] = { 95228, 95233, 95238, 95242, 95247, 95253, 95262, 95308 },           -- Leggings of the Crackling Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [96631] = { 96572, 96577, 96582, 96586, 96591, 96597, 96636, 96682 },           -- Leggings of the Crackling Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [95576] = { 95283, 95288, 95293, 95297, 95302, 95327 },                         -- Leggings of the Crackling Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [96632] = { 96657, 96662, 96667, 96671, 96676, 96727 },                         -- Leggings of the Crackling Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [95581] = { 95258, 95268, 95272, 95278, 95313, 95318, 95323, 95333, 95338 },    -- Leggings of the Crackling Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [96633] = { 96629, 96642, 96646, 96652, 96687, 96692, 96697, 96733, 96738 },    -- Leggings of the Crackling Protector (Warrior, Hunter, Shaman, Monk [HEROIC]
    [95573] = { 95229, 95234, 95239, 95244, 95249, 95254, 95264, 95309 },           -- Shoulders of the Crackling Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [96699] = { 96573, 96578, 96583, 96588, 96593, 96598, 96638, 96683 },           -- Shoulders of the Crackling Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [95578] = { 95284, 95289, 95294, 95299, 95304, 95329 },                         -- Shoulders of the Crackling Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [96700] = { 96658, 96663, 96668, 96673, 96678, 96729 },                         -- Shoulders of the Crackling Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [95583] = { 95259, 95269, 95274, 95279, 95314, 95319, 95324, 95334, 95339 },    -- Shoulders of the Crackling Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [96701] = { 96630, 96643, 96648, 96653, 96688, 96693, 96698, 96734, 96739 },    -- Shoulders of the Crackling Protector (Warrior, Hunter, Shaman, Monk [HEROIC]
    -- MOP Classic P5 (T16)
    -- Does NOT include Flex tier tokens, only Normal and Heroic
    [99689] = { 99126, 99133, 99136, 99110, 99119, 99204 },                         -- Helm of the Cursed Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [99694] = { 99157, 99140, 99150, 99154, 99106, 99101, 99107, 99203, 99206 },    -- Helm of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [99683] = { 99194, 99190, 99175, 99178, 99182, 99164, 99152, 99114 },           -- Helm of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [99690] = { 99128, 99135, 99138, 99122, 99117, 99097 },                         -- Shoulders of the Cursed Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [99695] = { 99159, 99142, 99148, 99156, 99093, 99103, 99109, 99196, 99200 },    -- Shoulders of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [99685] = { 99187, 99179, 99169, 99173, 99184, 99166, 99161, 99116 },           -- Shoulders of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [99686] = { 99130, 99125, 99132, 99111, 99120, 99205 },                         -- Chest of the Cursed Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [99696] = { 99167, 99144, 99151, 99146, 99095, 99105, 99100, 99201, 99197 },    -- Chest of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [99691] = { 99192, 99188, 99177, 99172, 99180, 99170, 99153, 99112 },           -- Chest of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [99687] = { 99127, 99134, 99137, 99121, 99131, 99096 },                         -- Gauntlets of the Cursed Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [99692] = { 99168, 99141, 99147, 99155, 99092, 99102, 99108, 99202, 99198 },    -- Gauntlets of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [99682] = { 99193, 99189, 99174, 99185, 99181, 99163, 99160, 99113 },           -- Gauntlets of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [99688] = { 99129, 99124, 99139, 99123, 99118, 99098 },                         -- Leggings of the Cursed Conqueror (Paladin, Priest, Warlock) [NORMAL]
    [99693] = { 99158, 99143, 99149, 99145, 99094, 99104, 99099, 99195, 99199 },    -- Leggings of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [NORMAL]
    [99684] = { 99186, 99191, 99176, 99171, 99183, 99165, 99162, 99115 },           -- Leggings of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [NORMAL]
    [99724] = { 99368, 99374, 99387, 99362, 99357, 99416 },                         -- Helm of the Cursed Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [99725] = { 99402, 99382, 99391, 99396, 99344, 99347, 99351, 99409, 99418 },    -- Helm of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [HEROIC]
    [99723] = { 99337, 99323, 99421, 99433, 99436, 99328, 99400, 99348 },           -- Helm of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [99718] = { 99370, 99376, 99379, 99360, 99366, 99425 },                         -- Shoulders of the Cursed Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [99719] = { 99404, 99384, 99389, 99393, 99332, 99341, 99353, 99407, 99414 },    -- Shoulders of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [HEROIC]
    [99717] = { 99339, 99325, 99423, 99428, 99431, 99322, 99398, 99350 },           -- Shoulders of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [99715] = { 99364, 99378, 99373, 99363, 99358, 99417 },                         -- Chest of the Cursed Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [99716] = { 99405, 99386, 99381, 99395, 99334, 99343, 99346, 99415, 99411 },    -- Chest of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [HEROIC]
    [99714] = { 99335, 99330, 99419, 99427, 99430, 99326, 99401, 99356 },           -- Chest of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [99721] = { 99369, 99375, 99380, 99359, 99365, 99424 },                         -- Gauntlets of the Cursed Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [99722] = { 99406, 99383, 99388, 99392, 99345, 99340, 99352, 99408, 99412 },    -- Gauntlets of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [HEROIC]
    [99720] = { 99336, 99331, 99420, 99432, 99435, 99327, 99397, 99355 },           -- Gauntlets of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [99712] = { 99371, 99377, 99372, 99361, 99367, 99426 },                         -- Leggings of the Cursed Conqueror (Paladin, Priest, Warlock) [HEROIC]
    [99713] = { 99403, 99385, 99390, 99394, 99333, 99342, 99354, 99410, 99413 },    -- Leggings of the Cursed Protector (Warrior, Hunter, Shaman, Monk) [HEROIC]
    [99726] = { 99338, 99324, 99422, 99434, 99429, 99329, 99399, 99349 },           -- Leggings of the Cursed Vanquisher (Rogue, DK, Mage, Druid) [HEROIC]
    [105858] = { },                                                                 -- Essence of the Cursed Conqueror [NORMAL]
    [105867] = { },                                                                 -- Essence of the Cursed Conqueror [HEROIC]
    [105857] = { },                                                                 -- Essence of the Cursed Protector [NORMAL]
    [105866] = { },                                                                 -- Essence of the Cursed Protector [HEROIC]
    [105859] = { },                                                                 -- Essence of the Cursed Vanquisher [NORMAL]
