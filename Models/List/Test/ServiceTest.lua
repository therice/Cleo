...
describe("Service Model", function()
	...
	describe("Service", function()
		...
		it("handles loot event", function()
			...
			assert.same (
				{'4372-00706FE5', '4372-01C6940A', '4372-01642E85', '1-00000031', '4372-011C6125', '4372-00C1D806', '1-00000045', '4372-000054BB', '4372-0034311C', '4372-0004FD18', '1-00000001', '1-00000002'},
				ol:GetPlayers(true)
			)
			-- BEFORE
			...
			-- {4372-00706FE5, 4372-01C6940A, 4372-01642E85, 1-00000031, 4372-011C6125, 4372-00C1D806, 1-00000045, 4372-000054BB, 4372-0034311C, 4372-0004FD18, 1-00000001, 1-00000002}
			-- AFTER
            -- {4372-00706FE5, 4372-01C6940A, 1-00000031, 4372-000054BB, 4372-011C6125, 4372-00C1D806, 1-00000045, 1-00000001, 4372-0034311C, 4372-0004FD18, 4372-01642E85, 1-00000002}
			assert.same (
					{'4372-00706FE5', '4372-01C6940A', '1-00000031', '4372-000054BB', '4372-011C6125', '4372-00C1D806', '1-00000045',  '1-00000001', '4372-0034311C', '4372-0004FD18', '4372-01642E85', '1-00000002'},
					ol:GetPlayers(true)
			)
			...
			al, ol =
				ac:GetActiveList("6154C601-3450-00C4-6D98-D3BF57AB9FA4"),
				ac:GetOriginalList("6154C601-3450-00C4-6D98-D3BF57AB9FA4")

			ac:OnPlayerEvent("4372-011C6125", true)

			assert.same (
				{ "1-00000031", "1-00000045", "4372-01642E85", "4372-00C1D806", "4372-000054BB", "4372-0034311C", "4372-00706FE5", "4372-0004FD18", "1-00000001", "4372-011C6125" },
				ol:GetPlayers(true)
			)
			assert.same (
				{ "1-00000031", [3] = "4372-01642E85",[5] = "4372-000054BB", [7] = "4372-00706FE5", [9] = "1-00000001", [10] = "4372-011C6125"},
				al:GetPlayers(true)
			)

			ac:OnLootEvent("4372-00706FE5", "INVTYPE_WEAPON", 0)
			...
			ac:OnLootEvent("4372-00706FE5", "INVTYPE_WEAPON", 5)

			assert.same(
				{ "1-00000031", [3] = "4372-01642E85",[5] = "4372-000054BB", [7] = "1-00000001", [9] = "4372-011C6125", [10] = "4372-00706FE5"},
				al:GetPlayers(true)
			)

			assert.same (
				{ "1-00000031", "1-00000045", "4372-01642E85", "4372-00C1D806", "4372-000054BB", "4372-0034311C", "1-00000001", "4372-0004FD18", "4372-011C6125", "4372-00706FE5"},
				ol:GetPlayers(true)
			)

			ac:OnLootEvent("4372-000054BB", "INVTYPE_WEAPON", 2)

			assert.same(
				{ "1-00000031", [3] = "4372-01642E85", [5] = "1-00000001", [7] = "4372-011C6125", [9] = "4372-000054BB", [10] = "4372-00706FE5"},
				al:GetPlayers(true)
			)

			assert.same (
				{ "1-00000031", "1-00000045", "4372-01642E85", "4372-00C1D806", "1-00000001", "4372-0034311C", "4372-011C6125", "4372-0004FD18", "4372-000054BB", "4372-00706FE5"},
				ol:GetPlayers(true)
			)
		...
		it("handles player left event", function()
			...
			assert.same (
					{'4372-00706FE5', '4372-01C6940A', '4372-01642E85', '1-00000031', '4372-011C6125', '4372-00C1D806', '1-00000045', '4372-000054BB', '4372-0034311C', '4372-0004FD18', '1-00000001', '1-00000002', '1-00000099'},
					ol:GetPlayers(true)
			)
