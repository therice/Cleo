...
describe("List Model", function()
	...
	describe("List", function()
		...
		it("handles players", function()
			...
			local l3 = List(uuid(), uuid(), "ListName2")
			l3:AddPlayer(Player:Get('Player1'))
			l3:AddPlayer(Player:Get('Player3'))
			l3:AddPlayer(Player:Get('Bud'))
			l3:AddPlayer(Player:Get('Eliovak'))
			l3:AddPlayer(Player:Get('Dee'))
			l3:AddPlayer(Player:Get('Player2'))
			l3:AddPlayer(Player:Get('Guy'))
			assert.equal(3, l3:GetPlayerPriority("Bud"))
			l3:DropPlayer("Bud")
			assert.equal(7, l3:GetPlayerPriority("Bud"))
			assert.equal(2, l3:GetPlayerPriority("Player3"))
			l3:DropPlayer("Player3", 2)
			assert.equal(4, l3:GetPlayerPriority("Player3"))
			assert.equal(1, l3:GetPlayerPriority("Player1"))
			l3:DropPlayer("Player1", 5)
			assert.equal(6, l3:GetPlayerPriority("Player1"))
			l3:DropPlayer("Player1", 100)
			assert.equal(7, l3:GetPlayerPriority("Player1"))
		end)
